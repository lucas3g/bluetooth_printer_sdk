...
public class BlueThermalPrinterPlugin {
    ...
    public boolean write(String message) throws Exception {
        if (THREAD == null) {
            throw new Exception("not connected");
        }
    ...
    public boolean writeBytes(byte[] message) throws Exception {
        if (THREAD == null) {
            throw new Exception("not connected");
        }
    ...
    public boolean printCustom(String message, int size, int align) throws Exception {
        // Print config "mode"
    ...
    public boolean printImage(String pathImage) throws Exception  {
        if (THREAD == null) {
            throw  new Exception("not connected");
        }
    ...
    public boolean printImageBytes(byte[] bytes) throws Exception {
        if (THREAD == null) {
            throw  new Exception("not connected");
        }
        try {
